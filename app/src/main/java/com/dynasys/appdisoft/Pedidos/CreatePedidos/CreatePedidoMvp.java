...
public interface CreatePedidoMvp {
    ...
    interface View {
        ...
        void ModifyItem(int pos, String value, DetalleEntity item, TextView tvsubtotal, EditText eCantidad, LinearLayout fondo, EditText eCatidadCajas);
        void ModifyItemCaja(int pos, String value, DetalleEntity item, TextView tvsubtotal, EditText eCantidad, LinearLayout fondo,EditText eCatidadCajas);
