...
private Activity act;
    ...
    public void onBindViewHolder(PedidosViewHolder clientesViewHolder, final int i) {
        ...
        clientesViewHolder.tvMontoContado.setText(ShareMethods.ObtenerDecimalToString(listaPedidos.get(i).getMontoContado(),2));
        clientesViewHolder.tvMontoCredito.setText(ShareMethods.ObtenerDecimalToString(listaPedidos.get(i).getMontoCredito(),2));
    ...
    public static class PedidosViewHolder extends RecyclerView.ViewHolder {
        ...
        protected TextView tvMontoContado,tvMontoCredito;
        ...
        public PedidosViewHolder(View v) {
            ...
            tvMontoContado=(TextView)v.findViewById(R.id.view_detalle_efectivo_montoContado);
            tvMontoCredito=(TextView)v.findViewById(R.id.view_detalle_efectivo_montoCredito);
