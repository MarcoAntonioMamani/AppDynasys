...
@Database(entities = {UserEntity.class, ClienteEntity.class, PrecioEntity.class, CobranzaDetalleEntity.class, ProductoEntity.class, PedidoEntity.class, DetalleEntity.class, StockEntity.class, ZonasEntity.class, DescuentosEntity.class, DeudaEntity.class, CobranzaEntity.class, AlmacenEntity.class}, version = 19)
