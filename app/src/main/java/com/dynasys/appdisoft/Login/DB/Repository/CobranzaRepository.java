...
public class CobranzaRepository {
    ...
    public void updateCobranza(CobranzaEntity user) {
        new CobranzaRepository.updateCobranzaAsync(mCobranzaDao).execute(user);
    }

    public void deleteCobranza(CobranzaEntity user) {
        new CobranzaRepository.deleteCobranzaAsync(mCobranzaDao).execute(user);
    }

    public void deleteAllCobranza() {
        new CobranzaRepository.deleteAllCobranzaAsync(mCobranzaDao).execute();
    }
